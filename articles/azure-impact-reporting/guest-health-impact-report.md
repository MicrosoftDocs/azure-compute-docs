  ...
  "value": [
    {
      ...
      "properties": {
        ...
        "content": {
          "description": "<h2><strong>Customer reports investigate state - HPC Acknowledge</strong></h2><p>The Azure monitoring and diagnostics systems identified that your resource <strong></strong> may have been impacted by <strong></strong>; a <strong></strong> platform change.</p><h3><strong>Root Cause</strong></h3><blockquote><p>The Host Node where the resource was running, or part of the resource dependency stack may have been impacted by this change, resulting in a brief impact.</p></blockquote><h3><strong>Resolution</strong></h3><blockquote><p>This state was transient.</p></blockquote><h3><strong>Additional Information</strong></h3><blockquote><p>Customers can control distribution of their resources at risk of effects from an infrastructure failure. For more details and example for VMs, see: <a href=\"https://docs.microsoft.com/azure/virtual-machines/windows/manage-availability\">Availability Options for Azure Virtual Machines</a>.</p></blockquote><blockquote><p>See also, <a href=\"https://docs.microsoft.com/azure/service-health/alerts-activity-log-service-notifications-portal\">Create activity log alerts on service notifications using the Azure portal</a>.</p></blockquote><h3><strong>Recommended Documents</strong></h3><blockquote><ul><li><a href=\"https://docs.microsoft.com/azure/virtual-machines/maintenance-and-updates\">Maintenance for virtual machines in Azure</a></li><li><a href=\"https://azure.microsoft.com/blog/service-healing-auto-recovery-of-virtual-machines\">Service Healing - Auto-recovery of Virtual Machines</a></li><li><a href=\"https://docs.microsoft.com/azure/virtual-machines/windows/tutorial-availability-sets\">Create and deploy virtual machines in an availability set using Azure PowerShell</a></li><li><a href=\"https://docs.microsoft.com/azure/storage/storage-managed-disks-overview\">Introduction to Azure managed disks</a></li><li><a href=\"https://docs.microsoft.com/azure/virtual-machines/windows/scheduled-events\">Azure Metadata Service: Scheduled Events for Windows VMs</a></li></ul></blockquote><p>We apologize for any inconvenience this may have caused you.</p><p>Microsoft Azure Team</p>",
    ...
    },
    {
      ...
      "properties": {
        ...
        "category": "MitigationAction",
        "content": {
          "description": "<h2><strong>Customer reports unhealthy state - HPC Unhealthy Pipeline Successful</strong></h2><p>The Azure monitoring and diagnostics systems identified that your resource <strong></strong> may have been impacted by <strong></strong>; a <strong></strong> platform change.</p><h3><strong>Root Cause</strong></h3><blockquote><p>The Host Node where the resource was running, or part of the resource dependency stack may have been impacted by this change, resulting in a brief impact.</p></blockquote><h3><strong>Resolution</strong></h3><blockquote><p>This state was transient.</p></blockquote><h3><strong>Additional Information</strong></h3><blockquote><p>Customers can control distribution of their resources at risk of effects from an infrastructure failure. For more details and example for VMs, see: <a href=\"https://docs.microsoft.com/azure/virtual-machines/windows/manage-availability\">Availability Options for Azure Virtual Machines</a>.</p></blockquote><blockquote><p>See also, <a href=\"https://docs.microsoft.com/azure/service-health/alerts-activity-log-service-notifications-portal\">Create activity log alerts on service notifications using the Azure portal</a>.</p></blockquote><h3><strong>Recommended Documents</strong></h3><blockquote><ul><li><a href=\"https://docs.microsoft.com/azure/virtual-machines/maintenance-and-updates\">Maintenance for virtual machines in Azure</a></li><li><a href=\"https://azure.microsoft.com/blog/service-healing-auto-recovery-of-virtual-machines\">Service Healing - Auto-recovery of Virtual Machines</a></li><li><a href=\"https://docs.microsoft.com/azure/virtual-machines/windows/tutorial-availability-sets\">Create and deploy virtual machines in an availability set using Azure PowerShell</a></li><li><a href=\"https://docs.microsoft.com/azure/storage/storage-managed-disks-overview\">Introduction to Azure managed disks</a></li><li><a href=\"https://docs.microsoft.com/azure/virtual-machines/windows/scheduled-events\">Azure Metadata Service: Scheduled Events for Windows VMs</a></li></ul></blockquote><p>We apologize for any inconvenience this may have caused you.</p><p>Microsoft Azure Team</p>",

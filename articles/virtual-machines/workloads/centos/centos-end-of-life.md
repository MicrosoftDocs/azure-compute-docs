...
| **Rocky Linux** | Official images:<br/>[Rocky Linux from CIQ for x86_64 (AMD64) - Official](https://marketplace.microsoft.com/en-us/product/ciq.rlc-plus?tab=Overview)<br/> [Conversion tool](https://docs.rockylinux.org/guides/migrate2rocky/) available from Rocky.| Yes (multiple publishers), BYOS, ARM64 | Community and commercial |
...
- [CentOS-based](https://marketplace.microsoft.com/)

---
title: In-place upgrade to Ubuntu Pro on Azure for individual VM
description: Learn how to do an in-place upgrade from Ubuntu Server to Ubuntu Pro for an individual VM
author: MarckK

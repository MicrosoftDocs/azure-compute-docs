...
Once you confirmed both the VM and the kernel support atomic writes, create an XFS filesystem with 16-KiB block size. You can do this using `sudo mkfs.xfs -b size=16384 <your-nvme-here>` (an example value for your NVMe is /dev/nvme0n2).

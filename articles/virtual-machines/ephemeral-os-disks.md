...
| Supported VM sizes | VMs with eight or more vCPUs in the following series. |
...
In case of choosing Standard SSD or Premium SSD base disk, customer will pay the applicable base disk charges **with either partial or full caching**.

...
1. Set the Boot Configuration Data (BCD) settings.
   ...
   ```
> [!NOTE]
> In order to be able to use Special Administration Console (SAC) at serial console and being able to troubleshoot OS issues as stated [here](https://learn.microsoft.com/troubleshoot/azure/virtual-machines/windows/serial-console-cmd-ps-commands), for example, the `Special Administration Console Helper (sacsvr)` service has to be running.

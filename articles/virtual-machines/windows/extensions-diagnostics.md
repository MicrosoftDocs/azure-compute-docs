...
[The Azure Diagnostics Extension schema and property values are described in this document.](/azure/azure-monitor/agents/diagnostics-extension-schema-windows)
...
[See this article](/azure/azure-monitor/agents/diagnostics-extension-troubleshooting) for a more comprehensive troubleshooting guide for the Azure Diagnostics extension.

#### Error: "Profile operation failed"

To enable profiling, please follow [Enable Profiler for web apps on an Azure virtual machine](/azure/azure-monitor/profiler/profiler-vm#enable-profiler-for-web-apps-on-an-azure-virtual-machine).
...
## Next Steps
* [Learn more about the Azure Diagnostics Extension](/azure/azure-monitor/agents/diagnostics-extension-overview)
* [Review the extension schema and versions](/azure/azure-monitor/agents/diagnostics-extension-schema-windows)

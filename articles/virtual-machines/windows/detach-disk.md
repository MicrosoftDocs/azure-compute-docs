---
title: "How to detach a data disk from a Windows virtual machine"
...
> [!WARNING]
> If you detach a disk, it isn't automatically deleted. If you subscribed to Premium storage, you continue to incur storage charges for the disk. For more information, see [Pricing and Billing when using Premium Storage](../disks-types.md#azure-managed-disk-billing).
...
- [Attach your managed disk to another VM](/azure/virtual-machines/windows/attach-managed-disk-portal)
- [Find and delete unattached Azure managed and unmanaged disks - Azure portal](/azure/virtual-machines/disks-find-unattached-portal)

...
# Grant a role definition to the user-assigned identity.  Please note, the success of the following command does rely on RBAC propagation, which can take up to ~30 minutes in some cases.  Please wait ~5 minutes before executing and retry after a delay if an error occurs.  

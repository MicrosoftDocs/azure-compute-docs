...
You can add a new data disk by using [az vm disk attach](add-disk.md) or [through the Azure portal](/azure/virtual-machines/linux/attach-disk-portal). Before you can encrypt, mount the newly attached data disk first. You must request encryption of the data drive because the drive is unusable while encryption is in progress.

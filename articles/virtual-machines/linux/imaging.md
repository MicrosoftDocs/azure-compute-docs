...
Azure allows you to bring a VHD to the platform to use as a managed disk by using the [Azure CLI](./disks-upload-vhd-to-managed-disk-cli.md) or [Azure PowerShell module](../windows/disks-upload-vhd-to-managed-disk-powershell.md), or as a source for an image.

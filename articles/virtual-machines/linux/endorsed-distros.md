...
|**Canonical / Ubuntu**| [Ubuntu 22.04 LTS (including Pro)](https://azuremarketplace.microsoft.com/marketplace/apps/canonical.ubuntu-22_04-lts?tab=Overview) <br/><br/> [Ubuntu 24.04 LTS (including Pro)](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/canonical.ubuntu-24_04-lts?tab=Overview)|Microsoft CSS provides commercially reasonable support for these images. | Canonical produces official Ubuntu images for Microsoft Azure and continuously tracks and delivers updates to these, ensuring security and stability are built from the moment your virtual machines launch. <br/><br/> Canonical works closely with Microsoft to optimize Ubuntu images on Azure and ensure Ubuntu supports the latest cloud features as they're released. Ubuntu powers more mission-critical workloads on Azure than any other operating system. <br/><br/> https://ubuntu.com/azure |
...
|**SUSE / SUSE Linux Enterprise Server (SLES)** | [SUSE 12 SP5 - +24x7 Support](https://azuremarketplace.microsoft.com/marketplace/apps/suse.sles-12-sp5?tab=Overview) <br/><br/>[SUSE 12 SP5 - SAP +24x7 Support](https://azuremarketplace.microsoft.com/marketplace/apps/suse.sles-sap-12-sp5?tab=Overview) <br/><br/> [SUSE 12 SP5 - BYOS](https://azuremarketplace.microsoft.com/marketplace/apps/suse.sles-12-sp5-byos?tab=Overview) <br/><br/> [SUSE 12 SP5 - SAP BYOS](https://azuremarketplace.microsoft.com/marketplace/apps/suse.sles-sap-12-sp5-byos?tab=Overview) <br/><br/>[SUSE 15 SP6 - +24x7 Support](https://azuremarketplace.microsoft.com/marketplace/apps/suse.sles-15-sp5?tab=Overview) <br/><br/> [SUSE 15 SP6 - Patching only](https://azuremarketplace.microsoft.com/marketplace/apps/suse.sles-15-sp6-basic?tab=Overview) <br/><br/> [SUSE 15 SP6 - SAP +24x7 Support](https://azuremarketplace.microsoft.com/marketplace/apps/suse.sles-sap-15-sp6?tab=Overview) <br/><br/> [SUSE 15 SP6 - BYOS](https://azuremarketplace.microsoft.com/marketplace/apps/suse.sles-15-sp6-byos?tab=Overview) <br/><br/> [SUSE 15 SP6 - SAP BYOS](https://azuremarketplace.microsoft.com/marketplace/apps/suse.sles-sap-15-sp6-byos?tab=Overview) <br/><br/> [SUSE 15 SP6 - arm64 +24x7 Support](https://azuremarketplace.microsoft.com/marketplace/apps/suse.sles-15-sp6-arm64?tab=overview) <br/><br/>[SUSE Enterprise Linux 15 SP7 +Patching](https://marketplace.microsoft.com/product/suse.sles-15-sp7-basic?tab=Overview) <br/><br/>[SUSE Linux Enterprise Server 15 SP7 +24x7 Support](https://marketplace.microsoft.com/product/suse.sles-15-sp7?tab=Overview)<br/><br/> [SUSE Linux Enterprise Server 15 SP7 - BYOS (x86_64)](https://marketplace.microsoft.com/product/suse.sles-15-sp7-byos?tab=Overview) <br/><br/>[SUSE Linux Enterprise Server 15 SP7 - Hardened BYOS (x86_64)](https://marketplace.microsoft.com/product/suse.sles-15-sp7-hardened-byos?tab=Overview)  <br/><br/>[SUSE Linux Enterprise Server for SAP Applications 15 SP7 - BYOS](https://marketplace.microsoft.com/product/suse.sles-sap-15-sp7-byos?tab=Overview) <br/><br/>[SUSE Enterprise Linux 15 SP7 for Arm64 +24x7 Support](https://marketplace.microsoft.com/product/suse.sles-15-sp7-arm64?tab=Overview) <br/><br/>[SUSE Linux Enterprise Server for SAP Applications 15 SP7 +24x7 Support](https://marketplace.microsoft.com/product/virtual-machines/suse.sles-sap-15-sp7?tab=Overview) <br/><br/> [SUSE Linux Enterprise Server 16.0 +24x7 Support](https://marketplace.microsoft.com/en-gb/product/suse.sles-16-0-x86-64?tab=Overview) <br/><br/> [SUSE Linux Enterprise Server for SAP Applications 16.0 +24x7 Support](https://marketplace.microsoft.com/product/virtual-machines/suse.sles-sap-16-0-x86-64?tab=Overview) <br/><br/>[SUSE Linux Enterprise Server for SAP Applications 16.0 - BYOS](https://marketplace.microsoft.com/product/suse.sles-sap-16-0-byos-x86-64?tab=Overview) <br/><br/> [SUSE Linux Enterprise Server 16.0 - BYOS (x86_64)](https://marketplace.microsoft.com/product/virtual-machines/suse.sles-sap-16-0-byos-x86-64?tab=Overview) <br/><br/> [SUSE Enterprise Linux 16.0 +Patching](https://marketplace.microsoft.com/product/suse.sles-16-0-basic-x86-64?tab=Overview) <br/><br/> [SUSE Enterprise Linux 16.0 for Arm64 +24x7 Support](https://marketplace.microsoft.com/product/suse.sles-16-0-arm64?tab=Overview) <br/><br/> [SUSE Linux Enterprise Server 16.0 for Arm64 - BYOS](https://marketplace.microsoft.com/product/suse.sles-16-0-byos-arm64?tab=Overview) <br/><br/> [SUSE Linux Enterprise Server 16.0 - Hardened BYOS (x86_64)](https://marketplace.microsoft.com/product/suse.sles-16-0-hardened-byos-x86-64?tab=Overview) <br/><br/>|Microsoft CSS provides commercially reasonable support these images.| SUSE Linux Enterprise Server on Azure is a proven platform that provides superior reliability and security for cloud computing. SUSE's versatile Linux platform seamlessly integrates with Azure cloud services to deliver an easily manageable cloud environment. With more than 9,200 certified applications from more than 1,800 independent software vendors for SUSE Linux Enterprise Server, SUSE ensures that workloads running supported in the data center can be confidently deployed on Azure. <br/><br/> https://www.suse.com/partners/alliance/microsoft |

|**SUSE / SUSE Linux Enterprise Server (SLES)** | [SUSE Linux Enterprise Server 12 SP5](https://marketplace.microsoft.com/marketplace/apps?search=sles-12-sp5) <br/><br/> [SUSE Linux Enterprise Server 15 SP5](https://marketplace.microsoft.com/marketplace/apps?search=sles-15-sp5) <br/><br/> [SUSE Linux Enterprise Server 15 SP6](https://marketplace.microsoft.com/marketplace/apps?search=sles-15-sp6) <br/><br/> [SUSE Linux Enterprise Server 15 SP7](https://marketplace.microsoft.com/marketplace/apps?search=sles-15-sp7) <br/><br/> [SUSE Linux Enterprise Server 16](https://marketplace.microsoft.com/marketplace/apps?search=sles-16) <br/><br/>|Microsoft CSS provides commercially reasonable support these images.| SUSE Linux Enterprise Server on Azure is a proven platform that provides superior reliability and security for cloud computing. SUSE's versatile Linux platform seamlessly integrates with Azure cloud services to deliver an easily manageable cloud environment. With more than 9,200 certified applications from more than 1,800 independent software vendors for SUSE Linux Enterprise Server, SUSE ensures that workloads running supported in the data center can be confidently deployed on Azure. 

Each Azure Marketplace **SUSE Linux Enterprise Server (SLES)** listing serves as a **single entry point** for a given major version and provides access to **all supported service packs and image variants**, including:
...
From each Marketplace page, customers can easily view and select the appropriate **service pack (SP)** and **deployment option** based on their workload and support requirements.
<br/><br/> https://www.suse.com/partners/alliance/microsoft |

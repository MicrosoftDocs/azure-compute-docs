...
|**SUSE / SUSE Linux Enterprise Server (SLES)** | [SUSE Linux Enterprise Server 12 SP5](https://marketplace.microsoft.com/marketplace/apps?search=sles-12-sp5) <br/><br/> [SUSE Linux Enterprise Server 15 SP5](https://marketplace.microsoft.com/marketplace/apps?search=sles-15-sp5) <br/><br/> [SUSE Linux Enterprise Server 15 SP6](https://marketplace.microsoft.com/marketplace/apps?search=sles-15-sp6) <br/><br/> [SUSE Linux Enterprise Server 15 SP7](https://marketplace.microsoft.com/marketplace/apps?search=sles-15-sp7) <br/><br/> [SUSE Linux Enterprise Server 16](https://marketplace.microsoft.com/marketplace/apps?search=sles-16-0) <br/><br/>|Microsoft CSS provides commercially reasonable support for these images.| SUSE Linux Enterprise Server on Azure is a proven platform that provides superior reliability and security for cloud computing. SUSE's versatile Linux platform seamlessly integrates with Azure cloud services to deliver an easily manageable cloud environment. With more than 9,200 certified applications from more than 1,800 independent software vendors for SUSE Linux Enterprise Server, SUSE ensures that workloads running supported in the data center can be confidently deployed on Azure.<br/><br/> Each Marketplace page provides access to all supported service packs and variants, including: <br/><br/> • +24x7 Support  <br/>• Patching-only  <br/>• BYOS (Bring Your Own Subscription)  <br/>• SLES for SAP Applications  <br/> • Arm64 <br/>• Hardened images <br/><br/> https://www.suse.com/partners/alliance/microsoft |

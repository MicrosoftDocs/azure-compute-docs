...
| apiVersion | The versioning information for the scheduled events specific metadata in the payload. This is unused during the preview. |
    ...
    "data": {
        "resourceInfo": { 
            ...
            "properties": {
                ...
                "ScheduledEventApiVersion": "2020-07-01"
             }
        },

...
**Confidential VMs** | Supported for application consistency only with size [v6-series](../confidential-computing/virtual-machine-options.md#sizes) in UAE North and Korea Central (**preview**)<br>[v5-series](../confidential-computing/virtual-machine-options.md#sizes) is not supported.<br>Not supported for crash consistency.
...
## Confidential Virtual Machines (Preview) 

**Scenarios** | **Supported by VM restore points**
--- | ---
**Consistency type** | Application consistent restore points
**Regions supported** | UAE North and Korea Central
**VM Sizes** | [v6-series] (../confidential-computing/virtual-machine-options.md#sizes) is supported.<br>[v5-series] (../confidential-computing/virtual-machine-options.md#sizes) is not supported.

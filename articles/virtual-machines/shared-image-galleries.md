...
- Disallowed disk types - you can provide information about the storage needs for your VM. For example, if the image isn't suited for Standard HDDs, you add them to the disallow list.

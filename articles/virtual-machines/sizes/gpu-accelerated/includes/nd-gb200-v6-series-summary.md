...
NVIDIA GB200 NVL72 connects up to 72 GPUs per rack, enabling the system to operate as a single computer. This 72 GPU rack scale system is comprised of groups of 18 ND GB200 v6 VMs delivering up to 1.4 Exa-FLOPS of FP4 Tensor Core throughput, 13.5 TB of shared high bandwidth memory, 130 TB/s of cross sectional NVLINK bandwidth, and 28.8 Tb/s scale-out networking.

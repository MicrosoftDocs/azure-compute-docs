...
> - You can use [Azure Policy](https://learn.microsoft.com/azure/governance/policy/overview) to ensure that only particular types of VM can be launched in your Azure accounts.

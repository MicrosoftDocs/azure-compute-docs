...
# Customer intent: "As a performance engineer, I want to understand the capabilities of HBv2-series VMs, so that I can determine if they meet the requirements for memory-intensive applications such as fluid dynamics and reservoir simulation."
---

...
#### Table definitions
- Total local temporary storage is calculated by multiplying the max number of storage disks with the temp disk size. For example, for the Standard_D96alds_v6, the total local temporary storage capacity is `6 x 880 GiB = 5,280 GiB`.
...
>
> Some Azure services may refer to this VM family as **Daldv6** rather than **Daldsv6**. This is a known naming inconsistency and does not affect VM capabilities, including Premium Storage support.

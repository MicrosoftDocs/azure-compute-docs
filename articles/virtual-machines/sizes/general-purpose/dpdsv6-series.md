...
#### Table definitions
- <sup>1</sup> Total local temporary storage is calculated by multiplying the max number of storage disks with the temp disk size. For example, for the Standard_D96pds_v6, the total local temporary storage capacity is `6 x 880 GiB = 5,280 GiB`.

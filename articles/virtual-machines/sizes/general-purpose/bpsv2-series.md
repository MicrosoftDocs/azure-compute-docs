...
# Customer intent: As a cloud architect, I want to review the specifications and features of Bpsv2 series virtual machines, so that I can select the appropriate size for my applicationΓÇÖs performance and resource requirements.
---
...
#### CPU Burst resources
- <sup>1</sup>The base CPU performance metric hasn't changed. The updated (2024) numbers were normalized using a `0 ΓÇô 100%` scale. Previously, the scale was `0 ΓÇô (vCPU x 100%)`.

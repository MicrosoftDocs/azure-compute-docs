...
| Memory         | 3.5 - 56 GiB          |                                                    |
| Local Storage  | 1 Disk     | 50 - 800 GiB <br>3,000 - 48,000 IOPS (RR) <br>46 - 750 MBps (RR)|
| Remote Storage | 4 - 64 Disks | 4x500 - 64x500 IOPS <br>Disk Types: [Standard SDD/HDD](../../../disks-types.md#standard-ssds) |
| Network        | 2 -  NICs          | 750 - 12,000  Mbps    <br>Interfaces: NetVSC, ConnectX, [MANA](https://aka.ms/ManaFAQ1)   |
| Accelerators   | None              |                                                     |
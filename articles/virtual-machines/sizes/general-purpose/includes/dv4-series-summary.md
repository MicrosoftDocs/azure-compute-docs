...
# Customer intent: "As a cloud architect, I want to review the specifications of the Dv4 and Dsv4-series virtual machines, so that I can select the optimal instance type for general-purpose workloads based on processor capabilities and performance features."
---

...
The current VM size retirement only affects the VM sizes in the [NV series](../../gpu-accelerated/nv-series.md). This retirement doesn't affect the [NVv3](../../gpu-accelerated/nvv3-series.md) and [NVv4](../../gpu-accelerated/nvv4-series.md) series VMs. 

## What actions should I take?

You'll need to resize or deallocate your NV VMs. We recommend moving your GPU visualizations or graphics workloads to another [GPU accelerated VM size](../../overview.md#gpu-accelerated).

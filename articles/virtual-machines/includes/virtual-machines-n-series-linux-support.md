...
>
> [vGPU20] (https://download.microsoft.com/download/51239696-ec04-4c02-a6b3-1d9c608fb57c/NVIDIA-Linux-x86_64-595.58.03-grid-azure.run) is now available for the NCv6 RTX PRO 6000 BSE series. vGPU20 is **not** yet supported on the NVadsA10_v5-series. We will provide an update for when vGPU20 is supported on the NVadsA10_v5-series. 

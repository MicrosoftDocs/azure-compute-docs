...
>
Microsoft redistributes NVIDIA GRID driver installers for NV, NVv3, NVads A10 v5-series, and NC RTX Pro 6000 BSE v6 VMs used as virtual workstations or for virtual applications. Install only the GRID drivers on these VMs, only on the operating systems listed in the following table. These drivers include licensing for GRID Virtual GPU Software in Azure. You don't need to set up a NVIDIA vGPU software license server.

The GRID drivers redistributed by Azure don't work on other N-series VMs like NCv2, NCv3, ND, and NDv2-series VMs. The one exception is the NCas_T4_V3 VM series where the GRID drivers enable the graphics functionalities similar to NV-series.

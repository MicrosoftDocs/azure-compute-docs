...
> [!Note]
> The Azure NVads A10 v5 VMs only support vGPU 17.x or higher driver version. The Azure NVadsA10_v5 The vGPU driver for the A10 SKU is a unified driver that supports both graphics and compute workloads.
>

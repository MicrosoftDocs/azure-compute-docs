...
- The encryption property of Premium SSD v2 and Ultra Disks created from incremental snapshots can’t be updated during disk hydration. Additionally, encryption settings can’t be updated for Premium SSD v2 and Ultra Disks with in-progress snapshot under background data copyor on the in-progress snapshot itself.

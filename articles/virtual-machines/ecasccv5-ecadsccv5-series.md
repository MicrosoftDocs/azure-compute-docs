---
title: Azure ECas_cc_v5-series
description: Specifications for Azure Confidential Computing's ECas_cc_v5-series confidential computing capable virtual machines.
author: ananyagarg
...
# Customer intent: As a cloud architect, I want to understand the specifications of ECas_cc_v5-series virtual machines, so that I can select the appropriate resources for my organization's memory-intensive enterprise applications and ensure data confidentiality.
---

# ECas_cc_v5-series (Preview)

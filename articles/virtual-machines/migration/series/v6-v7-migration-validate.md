...
1. **Platform validation:** boot, disks, drivers, and networking. Owned by the migration team.
1. **Workload confirmation:** the application is up and serving. A simple owner sign-off, not a full regression.
...
- [Frequently asked questions](v6-migration-faq.md)

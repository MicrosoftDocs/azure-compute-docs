...
### Operating system
For a list of supported operating systems, refer to [Operating Systems supported by Azure Backup](/azure/backup/backup-azure-arm-vms-prepare#before-you-start)

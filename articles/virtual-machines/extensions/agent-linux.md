...
| CIQ | Rocky Linux | 8.x, 9.x, 10.x | 8.x, 9.x, 10.x |
| SUSE | SUSE Linux Enterprise Server(SLES) | 12.x, 15.x, 16.x | 15.x, 16.x |
| Canonical | Ubuntu (LTS releases)| 18.04, 20.04, 22.04, 24.04, 26.04 | 20.04, 22.04, 24.04, 26.04 |

---
title: "Use the Azure portal to enable server-side encryption with customer-managed keys for managed disks"
...
7. When your disks finish switching over to customer-managed keys, if there are no other attached disks you'd like to encrypt, start your VM.
...
1. Go to the disk encryption set that you want to enable [automatic key rotation](disk-encryption.md#automatic-rotation-of-customer-managed-keys) on.

...
- On demand capacity reservation SLA does not apply to deployments using "LegacyVMNVA tag". See [MANA support for Network Virtual Appliances (NVAs)](/azure/virtual-network/accelerated-networking-mana-network-virtual-appliance-opt-out#can-the-policy-be-edited).

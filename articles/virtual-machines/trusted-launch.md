...
| [High Performance Compute](./sizes/overview.md#high-performance-compute) |[HBv2-series](./sizes/high-performance-compute/hbv2-series-overview.md)<sup>2</sup>, [HBv3-series](./sizes/high-performance-compute/hbv3-series-overview.md), [HBv4-series](./sizes/high-performance-compute/hbv4-series-overview.md), [HBv5-series](./sizes/high-performance-compute/hbv5-series-overview.md), [HC-series](./sizes/high-performance-compute/hc-series-overview.md)<sup>3</sup>, [HX-series](./sizes/high-performance-compute/hx-series-overview.md) | All sizes supported. | 
...
<sup>3</sup>HC-series sizes (Standard_HC44rs, Standard_HC44-16rs, Standard_HC44-32rs) are scheduled for retirement on May 31, 2027. After this date, remaining HC-series VMs will be deallocated and stop incurring charges, and HC-series will no longer have SLA or support. Sales of 1-year and 3-year Reserved Instances ended April 2, 2026. For new HPC Trusted Launch deployments, consider [HBv5-series](./sizes/high-performance-compute/hbv5-series-overview.md) for higher performance and better price-performance, or [HX-series](./sizes/high-performance-compute/hx-series-overview.md) for high-memory HPC workloads. Plan to transition off HC-series well before the retirement date to avoid disruption.

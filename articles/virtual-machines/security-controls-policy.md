---
title: Azure Policy Regulatory Compliance controls for Azure Virtual Machines 
...
page lists the **compliance domains** and **security controls** for Azure Virtual Machines . You can

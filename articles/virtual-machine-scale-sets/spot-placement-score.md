...
- Spot Placement Score supports both availability zone-scoped and nonzonal (regional) placement score. 
...
### Scenario 1
This table is an example of a request returning nonzonal scoped placement scores for multiple desired VM sizes and regions.

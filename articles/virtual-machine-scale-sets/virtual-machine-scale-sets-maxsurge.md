...
| **Enable cross-zone upgrade** | Allows the scale set to ignore Availability Zone boundaries when determining batches. This lets the rolling upgrade treat your scale set as a regional (nonzonal) deployment instead of a zone-spanning deployment. |

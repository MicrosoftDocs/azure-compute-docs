...
When a rolling upgrade is triggered in the Azure portal, a banner appears at the top of your scale set resource informing you that a rolling upgrade is in progress. You can select **View details** to see the status of the rolling upgrade. When all updates are complete, the banner disappears. 
